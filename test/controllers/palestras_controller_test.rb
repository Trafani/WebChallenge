...
class PalestrasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create palestra" do
    assert_difference("Palestra.count") do
      post palestras_url, params: { palestra: { duracao: @palestra.duracao, nome: @palestra.nome } }
    end
  ...
  test "should update palestra" do
    patch palestra_url(@palestra), params: { palestra: { duracao: @palestra.duracao, nome: @palestra.nome } }
